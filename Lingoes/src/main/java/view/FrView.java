...
public class FrView extends javax.swing.JFrame {
    ...
    private void initComponentsManually() {
        ...
        cbbInput.setPreferredSize(new Dimension(200, 30));
        cbbInput.setEnabled(true);
        cbbInput.setEditable(true);
        tfInput = (JTextField) cbbInput.getEditor().getEditorComponent();
...
//
//                    Word a = dictionaryService.getWord(cbbLanguge.getSelectedItem().toString(), word);
//                    epResult.setText(a.getContent());
//                }
//            }
//        });
//
//    }
    private void addWord() {
        ...
        cbbLanguge.addMouseListener(new MouseAdapter() {
            ...
            public void mousePressed(MouseEvent e) {
                ...
                if (cbbLanguge.getSelectedIndex() == 1) {
                    String[] strings = {"hoa"};
                    arr = new ArrayList<String>(Arrays.asList(strings));
                    for (String temp : strings) {
                        mod.addElement(temp);
    ...
    private void inputWord() {
        cbbInput.addMouseListener(new MouseAdapter() {
            @Override
            public void mousePressed(MouseEvent e) {
                Word a = dictionaryService.getWord(cbbLanguge.getSelectedItem().toString(), cbbInput.getSelectedItem().toString());
                epResult.setText(a.getContent());
                //  epResult.setText();tf
                tfInput.setText("");
            }
        ...
        tfInput.addKeyListener(new KeyAdapter() {
            ...
            public void keyPressed(KeyEvent e) {
                if (e.getKeyCode() == KeyEvent.VK_ENTER) {
                    Word a = dictionaryService.getWord(cbbLanguge.getSelectedItem().toString(), tfInput.getText());
                    epResult.setText(a.getContent());
                    tfInput.setText("");
                }
            }
...
//                cbbInput.setPopupVisible(true);
//                
//                List<String> listWord = dictionaryService.getWords(cbbLanguge.getSelectedItem().toString(), string);
//
//                cbbInput.removeAllItems();
//                for (String str : listWord) {
//                    cbbInput.addItem(str);
//                }
//                cbbInput.setPopupVisible(true);
//            }
            ...
            public void keyTyped(KeyEvent e) {
                ...
                List<String> listWord = dictionaryService.getWords(cbbLanguge.getSelectedItem().toString(), text);
    ...
    private void initComponents() {
        ...
        cbbInput = new javax.swing.JComboBox<>();
        ...
        epResult = new javax.swing.JEditorPane();
        ...
        cbbInput.setPreferredSize(new java.awt.Dimension(350, 22));
        cbbInput.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cbbInputActionPerformed(evt);
            }
        });
        pnInput.add(cbbInput);

        cbbLanguge.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "anh_viet", "viet_anh" }));
        cbbLanguge.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cbbLangugeActionPerformed(evt);
            }
        });
        pnInput.add(cbbLanguge);
        ...
        pnLeftLayout.setHorizontalGroup(
            ...
            .addGroup(pnLeftLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(sp, javax.swing.GroupLayout.DEFAULT_SIZE, 130, Short.MAX_VALUE)
                .addContainerGap())
        );
        pnLeftLayout.setVerticalGroup(
            pnLeftLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(pnLeftLayout.createSequentialGroup()
                .addComponent(sp, javax.swing.GroupLayout.PREFERRED_SIZE, 455, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        pnRightBottom.setBackground(new java.awt.Color(255, 255, 255));
        pnRightBottom.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        pnRightBottom.setPreferredSize(new java.awt.Dimension(0, 0));

        jScrollPane3.setViewportView(epResult);
        ...
        pnRightBottomLayout.setHorizontalGroup(
            ...
            .addGroup(pnRightBottomLayout.createSequentialGroup()
                .addContainerGap()
    ...
    private void cbbInputActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbbInputActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_cbbInputActionPerformed
    ...
    private javax.swing.JComboBox<String> cbbInput;
    private javax.swing.JComboBox<String> cbbLanguge;
    private javax.swing.JEditorPane epResult;
